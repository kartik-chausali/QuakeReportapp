...
Log.e("checking", "extractEarthquakes called");
//        try {
//            Thread.sleep(2000);  //by this we are forcing background thread to sleep for 2secs  before executing below code , main aim to do this is to checking indicator loading for a long time
...
//        }
        ...
        ArrayList<Earthquake>  earthquakes = fetchResponse(json);
        return earthquakes;

    }

    public static ArrayList<Earthquake> fetchResponse(String json){
        ...
        try {
            ...
            for(int i = 0; i<dataArray.length(); i++){
                ...
                JSONObject reqobject = dataobject.getJSONObject("properties");
                String url = reqobject.getString("url");
                double mag = reqobject.getDouble("mag");
                long time = reqobject.getLong("time");
                String place = reqobject.getString("place");
    ...
    public static String makeHTTP(URL url)throws IOException{
        ...
        try{
           ...
           if(httpURLConnection.getResponseCode()== 200){
               ...
               Log.e("Error", "Error response code "+httpURLConnection.getResponseCode());
           }
        }catch (Exception e){
            Log.e("Error", "Error making http");
        }finally {
